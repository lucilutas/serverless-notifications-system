export const templateGenerator = (title, body, {actionText, actionUrl}) => `<head>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding-top: 24px;">
                                                    <img src="https://saltandpepper.co/wp-content/uploads/2018/01/logo-header2.svg" style="height: 56px;">
                                                </td>
                                            </tr>
                                            <tr>
